...
import { BigintIsh, ZERO, ONE, TWO, THREE, SolidityType, SOLIDITY_TYPE_MAXIMA, FACTORY_WENDEX, WENDEX_CODE_HASH, FACTORY_FARMOLD ,FARMOLD_CODE_HASH } from './constants'
...
export function getInitHash(factory: string): string {
  switch(factory) {
    ...
    case FACTORY_FARMOLD:
      return FARMOLD_CODE_HASH;

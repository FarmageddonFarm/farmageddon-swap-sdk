...
export class Pair {
  ...
  public static getAddress(tokenA: Token, tokenB: Token, factory = FACTORY_ADDRESS): string {
  ...
  public constructor(tokenAmountA: TokenAmount, tokenAmountB: TokenAmount, factory = FACTORY_ADDRESS) {
